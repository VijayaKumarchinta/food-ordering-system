...
const Body = () => {
  ...
  return allRestaurants?.length === 0 ? (
    ...
    <>
      <div className="flex flex-col justify-start sm:flex-row sm:justify-between sm:items-center flex-wrap search-container p-2 md:p-3 bg-gray-200 rounded-md m-4 space-x-4">
