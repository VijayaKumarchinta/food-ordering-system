        ...
        <div className="flex flex-wrap text-left lg:text-left items-center">
          <div className="w-full lg:w-6/12 px-4">
            ...
            <div className="mt-6 lg:mb-0 mb-6">
              <a target="_blank" href="https://twitter.com/vijaychintaoo7">
                <button
              ...
              <a target="_blank" href="https://www.linkedin.com/in/chinta-vijaya-kumar-4a9551251/">
                <button
              ...
              <a target="_blank" href="https://github.com/VijayaKumarchinta">
                <button
